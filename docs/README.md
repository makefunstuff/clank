...
| [clank.md](clank.md) | model stage: flag table |
| [clank-jev.md](clank-jev.md) | typed gate: flag table, providers, gates, exit codes, six composed examples |
| [clank-web.md](clank-web.md) | fetch stage: flag table, providers, config, exit codes, one fetch |
...
The contract is [../PROTOCOL.md](../PROTOCOL.md). Recipes are in
[../CHEATSHEET.md](../CHEATSHEET.md). Flag tables are in [clank.md](clank.md),
[clank-jev.md](clank-jev.md), and [clank-web.md](clank-web.md). The repository's
enforceable conventions are the rules in [../.jev/rules](../.jev/rules).
